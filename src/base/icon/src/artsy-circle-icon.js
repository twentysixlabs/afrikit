...
import Icon, { ArtsyIconProps } from './artsy-icons';

interface CircleIconProps extends ArtsyIconProps {
  ratio?: number;
}

const CircleIconContainer = (styled.div: StyledFunction<CircleIconProps>)`
