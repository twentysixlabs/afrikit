...
Quoted.prototype.eval = function(context) {
  ...
  function iterativeReplace(thevalue, regexp, replacementFnc) {
    let evaluatedValue = thevalue;
    do {
      // eslint-disable-next-line
      thevalue = evaluatedValue;
      evaluatedValue = thevalue.replace(regexp, replacementFnc);
    } while (thevalue !== evaluatedValue);
